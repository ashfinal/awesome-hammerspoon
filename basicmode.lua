...
resizeM:bind('', 'F', 'Fullscreen', function() resize_win('fullscreen') end, nil, function() resize_win('fullscreen') end)
resizeM:bind('', 'C', 'Center Window', function() resize_win('center') end, nil, function() resize_win('center') end)
resizeM:bind('ctrl', 'C', 'Resize & Center', function() resize_win('fcenter') end, nil, function() resize_win('fcenter') end)
resizeM:bind('ctrl', 'H', 'Lefthalf of Screen', function() resize_win('halfleft') end, nil, function() resize_win('halfleft') end)
resizeM:bind('ctrl', 'J', 'Downhalf of Screen', function() resize_win('halfdown') end, nil, function() resize_win('halfdown') end)
resizeM:bind('ctrl', 'K', 'Uphalf of Screen', function() resize_win('halfup') end, nil, function() resize_win('halfup') end)
resizeM:bind('ctrl', 'L', 'Righthalf of Screen', function() resize_win('halfright') end, nil, function() resize_win('halfright') end)
resizeM:bind('ctrl', 'Y', 'NorthWest Corner', function() resize_win('cornerNW') end, nil, function() resize_win('cornerNW') end)
resizeM:bind('ctrl', 'U', 'SouthWest Corner', function() resize_win('cornerSW') end, nil, function() resize_win('cornerSW') end)
resizeM:bind('ctrl', 'I', 'SouthEast Corner', function() resize_win('cornerSE') end, nil, function() resize_win('cornerSE') end)
resizeM:bind('ctrl', 'O', 'NorthEast Corner', function() resize_win('cornerNE') end, nil, function() resize_win('cornerNE') end)
